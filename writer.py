...
# model/Gemma-The-Writer-9B-D_AU-Q3_k_s.gguf
import sys
...
llm = Llama(
            model_path='model/Gemma-The-Writer-9B-D_AU-Q3_k_s.gguf',
            n_gpu_layers=0,
            temperature=1.1,
            top_p = 0.5,
            n_ctx=8192,
...
print("2. Model Gemma-The-Writer-9B-D_AU-Q3_k_s.gguf loaded with LlamaCPP...")
